...
export class CreateAdoptionRequestDto {
  // `adopterId` é resolvido a partir do JWT.
  // `protetorId` vem do cliente (quem criou o pet), pois o adoption service
  // não acessa o catalog DB diretamente.
  @ApiProperty({ example: 'b3a6f6b2-7d63-4b02-9f0e-9b37f9499c7d' })
  @IsUUID()
  petId!: string;

  @ApiPropertyOptional({ example: 'e4458d5f-621a-4a3e-bf61-3a5fdad66cce' })
  @IsOptional()
  @IsString()
