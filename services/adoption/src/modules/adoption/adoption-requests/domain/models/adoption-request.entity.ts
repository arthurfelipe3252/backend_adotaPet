...
export class AdoptionRequest {
  ...
  get protetorId(): string | null | undefined { return this._protetorId; }
  get adopterId(): string { return this._adopterId; }
  get status(): AdoptionRequestStatus { return this._status; }
  get preTriageStatus(): AdoptionPreTriageStatus { return this._preTriageStatus; }
  get matchScore(): number | null | undefined { return this._matchScore; }
  get matchAnswers(): Record<string, string | number | boolean | null> | null | undefined { return this._matchAnswers; }
  get notes(): string | null | undefined { return this._notes; }
  get createdAt(): Date | undefined { return this._createdAt; }
  get updatedAt(): Date | undefined { return this._updatedAt; }

  withStatus(status: AdoptionRequestStatus) { this._status = status; return this; }
  withPreTriageStatus(status: AdoptionPreTriageStatus) { this._preTriageStatus = status; return this; }
  withMatchScore(score?: number | null) { this._matchScore = score ?? null; return this; }
  withMatchAnswers(answers?: Record<string, string | number | boolean | null> | null) { this._matchAnswers = answers ?? null; return this; }
  withProtetorId(protetorId?: string | null) { this._protetorId = protetorId ?? null; return this; }
  withNotes(notes?: string | null) { this._notes = notes; return this; }
  touch(updatedAt: Date) { this._updatedAt = updatedAt; return this; }

  static create(props: Omit<AdoptionRequestProps, 'id' | 'createdAt' | 'updatedAt' | 'status' | 'preTriageStatus'> & { status?: AdoptionRequestStatus; preTriageStatus?: AdoptionPreTriageStatus }): AdoptionRequest {
    const now = new Date();
    const entity = new AdoptionRequest(crypto.randomUUID(), now, now);
