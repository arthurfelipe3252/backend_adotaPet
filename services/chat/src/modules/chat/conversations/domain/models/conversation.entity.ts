...
export class Conversation {
  ...
  get adoptionRequestId(): string { return this._adoptionRequestId; }
  ...
  withActive(isActive: boolean) { this._isActive = isActive; return this; }
  touch(updatedAt: Date) { this._updatedAt = updatedAt; return this; }

  static create(props: Omit<ConversationProps, 'id' | 'createdAt' | 'updatedAt'>): Conversation {
    const now = new Date();
    const entity = new Conversation(crypto.randomUUID(), now, now);
