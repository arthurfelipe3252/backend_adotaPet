...
export class QuestionarioMatch {
  ...
  get adotanteId(): string {
    return this._adotanteId;
  }
  get tipoMoradia(): TipoMoradia {
    return this._tipoMoradia;
  }
  get disponibilidade(): Disponibilidade {
    return this._disponibilidade;
  }
  get experienciaPrevia(): ExperienciaPrevia {
    return this._experienciaPrevia;
  }
  get criancasEmCasa(): CriancasEmCasa {
    return this._criancasEmCasa;
  }
  get outrosPets(): OutrosPets {
    return this._outrosPets;
  }
  get perfilCompanheiro(): PerfilCompanheiro {
    return this._perfilCompanheiro;
  }
  ...
  withTipoMoradia(v: TipoMoradia): this {
    this._tipoMoradia = v;
    return this;
  }
  withDisponibilidade(v: Disponibilidade): this {
    this._disponibilidade = v;
    return this;
  }
  withExperienciaPrevia(v: ExperienciaPrevia): this {
    this._experienciaPrevia = v;
    return this;
  }
  withCriancasEmCasa(v: CriancasEmCasa): this {
    this._criancasEmCasa = v;
    return this;
  }
  withOutrosPets(v: OutrosPets): this {
    this._outrosPets = v;
    return this;
  }
  withPerfilCompanheiro(v: PerfilCompanheiro): this {
    this._perfilCompanheiro = v;
    return this;
  }

  touch(date: Date): this {
  ...
  static create(
    props: Omit<QuestionarioMatchProps, 'id' | 'createdAt' | 'updatedAt'>,
  ): QuestionarioMatch {
    if (!props.adotanteId) {
      throw new DomainException(
        'adotanteId é obrigatório para o questionário de match.',
      );
    }
  ...
  static restore(props: QuestionarioMatchProps): QuestionarioMatch {
    const entity = new QuestionarioMatch(
      props.id,
      props.createdAt,
      props.updatedAt,
    );
